<div class="w-full bg-white py-3 px-4 shadow-lg relative flex rounded-lg">
            ...
            <div id="overlay-example" class="overlay overlay-open:translate-x-0 !w-5/6 drawer drawer-start hidden"
                ...
                <div class="drawer-body !p-2">
                    <div class="w-full">
                        ...
                        <a href="#">
                            <div
                                class="w-full bg-green-200 p-1 border-e-5 lg:border-e-7 border-green-500 flex justify-between hover:bg-green-400 transition  ease-in-out hover:border-yellow-500 pointer cursor-pointer rounded-bl-[15px]">
                        ...
                        <div class="p-0">
                            ...
                            <ul class="menu accordion w-full space-y-0.5 bg-blue-50 !text-xs">
                                <li>
    ...
    echo '';  ?> collapse-open:bg-base-content/10" id="menu-app" data-collapse="#menu-app-collapse2">
                                    ...
                                    <ul id="menu-app-collapse2" class="collapse w-auto space-y-0.5 overflow-hidden transition-[height] duration-300 <?php if ($current == 'admin/post' || $current == 'admin/post/create')
    echo 'open';
else
    ...
    echo '';  ?>" id="menu-category" data-collapse="#menu-category-collapse2">
    ...
    echo '';  ?>" id="menu-media" data-collapse="#menu-media-collapse2">
                                        <span class="icon-[qlementine-icons--media-16] size-5"></span>
                                        رسانه
                                        <span
                                            class="icon-[tabler--chevron-down] collapse-open:rotate-180 size-4 transition-all duration-300"></span>
                                    </a>
                                    <ul id="menu-media-collapse2" class="<?php if ($current == 'admin/category/' || $current == 'admin/category/craete')
    echo 'open';
else
    echo 'hidden';  ?> collapse w-auto space-y-0.5 overflow-hidden transition-[height] duration-300"
                                        aria-labelledby="menu-media">
                                        <li>
                                            <a href="#">
    ...
    echo '';}  ?>" id="menu-setting" data-collapse="#menu-setting-collapse2">
                                        <span class="icon-[tabler--settings] size-5"></span>
                                        تنظیمات
                                        <span
                                            class="icon-[tabler--chevron-down] collapse-open:rotate-180 size-4 transition-all duration-300"></span>
                                    </a>
                                    <ul id="menu-setting-collapse2" class="<?php if ($current == 'admin/category/' || $current == 'admin/category/craete'){
    echo 'open';}
else{
    echo 'hidden';}  ?> collapse w-auto space-y-0.5 overflow-hidden transition-[height] duration-300"
                                        aria-labelledby="menu-setting">
                                        <li>
                                            <a href="#">
